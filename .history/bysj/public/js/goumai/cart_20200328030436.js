                            ...
                            <div class="shop-cart-footer">\
                                <div class="cart-foot clearfix">\
                                    ...
                                    <div class="cart-foot-right">\
                                        ...
                                        <a id="Modal" class="order-btn ban-order">去结算</a>\
                                    </div>\
                                </div>\
                            </div>\
                        </div >');
...
var datas = {
    ...
    '图书': [
        {
            'name': '《孔子智慧101》',
            "img": '../../images/goumai/15.1.jpg',
            'goodTip': '商务印书馆出品',
            'singalPrice': '￥24.00'
        },
        {
            'name': '《探寻中国的现代性》',
            "img": '../../images/goumai/16.1.jpg',
            'goodTip': '清华大学教授汪晖出版',
            'singalPrice': '￥29.00'
        },
        {
            'name': '《时尚文化的启蒙时代》',
            "img": '../../images/goumai/17.1.jpg',
            'goodTip': '18世纪宫廷女装文化',
            'singalPrice': '￥29.00'
        },
        {
            'name': '《中国历代谜案》',
            "img": '../../images/goumai/18.1.jpg',
            'goodTip': '对我国历史上有重大影响的近20件历史事件',
            'singalPrice': '￥17.90'
        }
...
$("#Modal").click(function(){
    $("#myModal").css({"opacity":"1","margin-top":"-1050px"})
    $("#myModal").css({
'transition': 'all,1s',
})
  })
  $("#myModal button:first-child").click(function(){
    $("#myModal").css({"opacity":"0","margin-top":"-190px"})
    $("#myModal").css({
'transition': 'all,1s',
})
  })
  $("#myModal button:nth-child(2)").click(function(){
    alert("下单成功，即将为您派单！")
    $("#myModal").css({"opacity":"0","margin-top":"-190px"})
    $("#myModal").css({
'transition': 'all,1s',
