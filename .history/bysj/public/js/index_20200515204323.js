...
//   var imgs =["./images/head0.webp", "./images/head1.webp", "./images/head2.webp","./images/head3.webp"];    //（设定想要显示的图片）
//   var i = 0;
...
var arr=[
  {"uname":"李甜甜","upwd":"123456"},
  {"uname":"曹蓉蓉","upwd":"234567"},
  {"uname":"孙高峰","upwd":"222222"},
  {"uname":"程雪","upwd":"333333"},
  {"uname":"陈诚","upwd":"444444"},
  {"uname":"崔静静","upwd":"555555"},
  {"uname":"胡丽萍","upwd":"666666"},
  {"uname":"附件","upwd":"777777"},
  {"uname":"董秀霞","upwd":"888888"},
  {"uname":"李芳芳","upwd":"999999"}
]
...
$(".loginBtn").click(function(){
  for(var i=0;i<arr.length;i++){
    ...
    if(userName==arr[i].uname && userPas==arr[i].upwd){
      alert("登录成功"); 
      $("#qufeng").css("opacity","1");
      $("#qufeng").html(`尊敬的${arr[i].uname}您好`);
      return;
    }
  }
  for(var i=0;i<arr.length;i++){
  ...
  // else if(userName==arr[i].uname && userPas !=arr[i].upwd){
    //   alert("密码错误")
    //   return;
    // }else{
    //   alert("用户名不存在")
...
$("#goumai").click(function(){
  var a=$("#qufeng").html();
  window.open("main/goumai/main.html"+a,"_self")
  window.open("detail.html?"+a+"?"+b+"?"+c+"?"+d+"?"+e);
  // if($("#qufeng").css('opacity') == "1"){
  //   window.open("main/goumai/main.html","_blank ")
  //   //window.location.href="main/juanzeng/main2.html";
  // }
})
$("#juanzeng").click(function(){
  window.open("main/juanzeng/main2.html","_self")
  // if($("#qufeng").css('opacity') == "1"){
  //   window.open("main/juanzeng/main2.html","_blank ")
  //   //window.location.href="main/goumai/main.html";
  // }
})

$("#cf-submit").click(function(){
  if($("#cf-name").val()=="" || $("#cf-email").val()=="" || $("#cf-subject").val()==""|| $("#cf-message").val()==""){
    alert("必填项不得为空")
  }else{
    confirm("我们已经收到您的反馈！")
  }
...
$(".loginBtn2").click(function(){
  if($("#uName").val()==""||$("#uPas").val()==""){
    alert("必填项不得为空")
  }else if($("#checkuserPas").val()==""){
    alert("请确认密码")
  }else{
    alert("注册成功")
    var obj={"uname":`${$("#uName").val()}`,"upwd":`${$("#uPas").val()}`}
    arr.push(obj);
    console.log(arr)
  }
})